export const ThrusterV3PoolAbi = [
    { inputs: [] as any[], stateMutability: "nonpayable", type: "constructor" },
    {
        anonymous: false,
        inputs: [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: "uint256", name: "amountUSDB", type: "uint256" },
            { indexed: false, internalType: "uint256", name: "amountGas", type: "uint256" }
        ],
        name: "ClaimYieldAll",
        type: "event"
    },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: "address", name: "gauge", type: "address" }],
        name: "SetGauge",
        type: "event"
    },
    {
