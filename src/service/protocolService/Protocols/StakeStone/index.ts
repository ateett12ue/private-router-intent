...
import { getCommonDecimalComputedValue, getTokenReverseValue } from "../../../../utils/index";
...
class StakeStoneProtocol extends ProtocolBase
{
    ...
    ): Promise<CreateProtocolDefaultParamsResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                let protocolActions = data.action;
                ...
                if (protocolActions == "stake")
                {
                    ...
                    )
                    {
                        ...
                        const canonicalParams: CreateAdapterDefaultParams = {
                            adapterId: STAKESTONE_CANONICAL_BRIDGE,
                            ...
                            partnerId: partnerId,
                            protocolData: { ...data.protocolData, type: "layerzero" }
                        };
...
export default StakeStoneProtocol;
