...
interface ThrusterV3SupplyData
{
    token0: TokenData;
    token1: TokenData;
    tickLower: string;
...
class ThrusterV3PoolAdapter extends AmmAdapterBase
{
    ...
    ): Promise<CreateAdapterDefaultParamsResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const quoteData: ThrusterV3SupplyData = {
                    token0: data.tokenA,
                    token1: data.tokenB,
    ...
    ComposeCalldata(adapter: AdapterIdParamsResponse): Promise<CalldataResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const adapterData: ThrusterV3SupplyData = adapterOptions.data;
...
export default ThrusterV3PoolAdapter;
