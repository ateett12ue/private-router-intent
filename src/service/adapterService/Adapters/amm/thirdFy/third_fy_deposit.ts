...
class ThirdFyPoolAdapter extends AmmAdapterBase
{
    ...
    ): Promise<CreateAdapterDefaultParamsResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const quoteData: ThirdFySupplyData = {
                    token0: data.tokenA,
                    token1: data.tokenB,
    ...
    ComposeCalldata(adapter: AdapterIdParamsResponse): Promise<CalldataResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const adapterData: ThirdFySupplyData = adapterOptions.data;
...
export default ThirdFyPoolAdapter;
