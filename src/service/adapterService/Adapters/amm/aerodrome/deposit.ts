...
class AerodromePoolAdapter extends AmmAdapterBase
{
    ...
    ): Promise<CreateAdapterDefaultParamsResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const quoteData: AeroSupplyData = {
                    tokenA: data.tokenA,
                    tokenB: data.tokenB,
                    stable: data.stable,
        ...
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                */
                ...
                const adapterData: AeroSupplyData = adapterOptions.data;
...
export default AerodromePoolAdapter;
