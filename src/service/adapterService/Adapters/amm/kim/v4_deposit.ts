...
class KimV4PoolAdapter extends AmmAdapterBase
{
    ...
    ): Promise<CreateAdapterDefaultParamsResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const quoteData: KimV4SupplyData = {
                    token0: data.tokenA,
                    token1: data.tokenB,
    ...
    ComposeCalldata(adapter: AdapterIdParamsResponse): Promise<CalldataResponse>
    {
        return new Promise(async (resolve, reject) =>
        {
            try
            {
                ...
                const adapterData: KimV4SupplyData = adapterOptions.data;
...
export default KimV4PoolAdapter;
